...
files = ["5p1hz60deg.mfprof", "5p1hz90deg.mfprof", "5p1hz120deg.mfprof"]
# files = ["5p05hz90deg.mfprof", "5p05hz120deg.mfprof", "5p05hz150deg.mfprof"]
...
for file in files:
    ...
    analysis.channelRange(66, 95)
    analysis.cylinderGeom(77, 22.6, 9.63)
