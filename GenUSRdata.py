...
#Velocitu profile calculation from Bessel function ----------------------------
...
Phir = J1r.real; PhiRR = J1RR.real # Extraction of real part
Psir = J1r.imag; PsiRR = J1RR.imag # Extractin of imaginary part
...
+str(Nt)+','+str(Nxi)+','+str(Dt*1000)+','+str(Dxi)+',-,'+str(ws)+','+str(nuset)+','+str(f0)+','+str(Ang)+','+str(RR)+','+str(DX0)+','
...
plt.text(0.5, 1.1, r'$\nu$ = '+str(nuset)+r' [mm$^2$/s], $f_0 = $'+str(f0)+r' [Hz], $\Theta$ = '+str(Ang)+r' [deg]', horizontalalignment="center",
