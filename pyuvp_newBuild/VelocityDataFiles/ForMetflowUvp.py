...
class readFile:
    ...
    def __read_FileHeader(self, uvp_datafile) -> None:
        """
    ...
    def __read_data(self, file_path) -> None:
        ...
        self.__read_FileHeader(uvpDatafile)
