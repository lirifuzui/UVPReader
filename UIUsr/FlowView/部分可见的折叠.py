...
class MyWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # 设置左侧树状图的初始宽度为 200
        menu_tree_widget.resize(200, menu_tree_widget.height())

        # 设置最小宽度为 100 像素，确保左侧树状图不会完全折叠
        menu_tree_widget.setMinimumWidth(100)

        # 设置主窗口的中心区域为 QSplitter
        self.setCentralWidget(splitter)

        # 设置窗口标题
        self.setWindowTitle('带有最小宽度的树状菜单和窗口')
